							...
							<div class="accordion-body">
								...
								<div class="col-md-12 filterDiv filterDivMaster pb-3 col-sm-12 mb30" <?=$filterDivMaster?>>
									...
									<div class="col-md-12  col-sm-12 mb30">
										<a href="pathology/lab-blood-test-near" class="btn-main bg-grengradi lnk w-100">Pathology Packages <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
									</div>
								</div>
							</div>
						</div>
	...
	<div class="container">
		...
		<div class="row ">
			...
			<div class="col-md-6 col-md-6 mt-3 mt-lg-0 mt-md-0">
				<div class="common-heading-2 text-start">
					<h2 class="mb20">Frequently Asked Questions (FAQs) for Book Your Scan in <?=$this->city_name?></h2>
				</div>
				...
				<div class="accordion" id="accordionExample">
					<?php 
						...
						?>
						<div class="accordion-item">
							<h2 class="accordion-header" id="heading-<?= $this->rs_faq_data[$i]['id'] ?>">
								<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-<?= $this->rs_faq_data[$i]['id'] ?>" aria-expanded="false" aria-controls="collapse-<?= $this->rs_faq_data[$i]['id'] ?>">
									<?= $question ?>
								</button>
							</h2>
							<div id="collapse-<?= $this->rs_faq_data[$i]['id'] ?>" class="accordion-collapse collapse" aria-labelledby="heading-<?= $this->rs_faq_data[$i]['id'] ?>" data-bs-parent="#accordionExample">
								<div class="accordion-body">
									<div class="data-reqs">
										<p><?=$answer?></p>
									</div>
