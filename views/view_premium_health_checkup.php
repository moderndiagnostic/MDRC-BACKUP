...
<div class="text-block">
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-6">
				<h2 class="wow fadeInUp fs-3 f-bold text-white" data-wow-delay=".2s">MODERN Health Checkup Tests</h2>
			</div>
		</div>
	</div>
</div>
		...
		<div class="container">
			<div class="row ">
				...
				<div class="col-md-6 col-md-6 mt-3 mt-lg-0 mt-md-0">
					<div class="common-heading-2 text-start">
						<h2 class="mb20">Frequently Asked Questions (FAQs) for Full Body Health Checkup in <?=$this->city_name?></h2>
					</div>
