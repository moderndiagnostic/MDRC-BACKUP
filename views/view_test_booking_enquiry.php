    ...
    <div class="row align-items-center">
      <div class="col-lg-5 col-md-6 col-12">
        <div class="common-heading-1 text-l text-center text-lg-start text-md-start">
          <h1 class="mb20 text-center text-lg-start text-md-start text-white fs-1">Not Able to Find Your Test / Scan?</h1>
          ...
          <form method="post" id="prescription_booking" name="prescription_booking" class="shake mt30">
            ...
            <div class="row">
              <div class="form-group">
                ...
                <label class="text-dark"><input type="radio" value="MRI/CT Scan Etc" id="test_mri_ctscan" name="test_type" checked> MRI | CT Scan | PET-CT | SPECT | Ultrasound..etc</label>
              </div>
            </div><br/>
