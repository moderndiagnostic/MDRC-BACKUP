...
<link href="css/custom.css?v=12.5" rel="stylesheet">
<!--Start Header -->
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-12 block-1">
				<div class="common-heading text-l pl25 diseases">
				...
				<?php if (count($this->rs_area) > 0) { ?>
					<div class="col-lg-12 col-sm-12 pb50 pt50 bg-light text-center">
						...
						<?php for ($i = 0; $i < count($this->rs_area); $i++) { ?>
							<a href="diseases/<?=$_SESSION['citySlug']?>/<?=$this->slug?>/<?=$this->rs_area[$i]['slug']?>" class="tags">Lab Test In <?= $this->rs_area[$i]['name'] ?></a>
						<?php } ?>
					</div>
				<?php } ?>
			</div>
