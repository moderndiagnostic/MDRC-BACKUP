                ...
                <div class="cart-extra-sevc div-for-data">
                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr class="tpayable">
                                <th>Total Paid</th>
                                <td><span class="prc"><i class="fas fa-rupee-sign"></i><?= array_sum(array_column($this->result_pay,'transaction_amount')) ?></span></td>
                            </tr>
                            <tr class="tpayable">
                                <th>Balance Due Before Test</th>
                                <td><span class="prc"><i class="fas fa-rupee-sign"></i><?= $this->rs_data[0]['net_order_value'] - array_sum(array_column($this->result_pay,'transaction_amount')) ?></span></td>
                            </tr>
                        </tbody>
                    </table>
