...
<main class="health-package-page page-common">
	...
	<div class="pathology-radiology">
		<div class="row m-0 g-3">
			<div class="col-6 pathology no-active px-2 py-3 mt-0 border-end">
				<div class="d-flex justify-content-center w-100">
					<a href="<?=M_SERVER_ROOT;?>/pathology/lab-blood-test-near/<?=$_SESSION['citySlug'];?>" class="d-flex ra-link align-items-center">
						<img src="assets/images/mdrc/health-package/pathology.png" alt="" class="img-fluid me-3">
						<span class="fw-bold">Pathology</span>
					</a>
				</div>			
			</div>
			<div class="col-6 radiology activee px-2 py-3 mt-0">
				<div class="d-flex justify-content-center w-100">
					<a href="<?=M_SERVER_ROOT;?>/radiology/imaging-lab-tests-near/<?=$_SESSION['citySlug'];?>" class="d-flex pa-link align-items-center">
			...
			<div class="col-12 radiology active">
				<div class="Marquee">
					<div class="Marquee-content">
						...
						<a class="Marquee-tag categoryClick" href="javascript:void(0)" data-id="<?=$this->rs_category[$i]['id']?>" data-value="<?=$this->rs_category[$i]['id']?>" data-title="<?=$this->rs_category[$i]['name']?>"><?=$this->rs_category[$i]['name']?></a>
						<?php }?>
					</div>
				</div>
			</div>
...
<!-- Sticky Kart Start -->
<a href="<?=SERVER_ROOT;?>/cart" class="msite_cart" <? if(count($this->rs_cartmini)<=0) {?> style="display: none;" <?php } ?> >
