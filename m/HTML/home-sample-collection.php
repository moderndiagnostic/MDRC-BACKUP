...
<body>
    ...
    <header class="header">
        <div class="logo-wrap">
            ...
            <h2 class="fw-bold font-md">Home Sample Collection</h2>
        </div>
    </header>
    <!-- Header End -->
    ...
    <main class="main-btm-pd bg-white page-common">
        ...
        <div class="card bg-theme rounded-0 border-0 p-3">
            <h2 class="font-lg text-left text-white mb-3">Not able to find your test?</h2>
            <p class="text-white text-left">
                Blood tests can be done through home blood sample collection services that do away with the need to travel to the laboratory. Please fill up the following details for appointment. You will receive an confirmation call from centre regarding appointment details.
            </p>
            <!-- <a href="#" class="btn btn-solid btn-sm bg-white text-dark shadow1 wd-150 d-inline-block ">Book an appointment</a> -->

        </div>

        <!-- Home Sample Collection form start -->
        <div class="sample-collection-form p-3">
            <div class="form-block fdgn2 mt10 mb10">
                <form method="post" id="collection_appointment" name="collection_appointment">
                    <div class="fieldsets row">
                        <div class="col-md-12"><input required="required" type="text" placeholder="Full Name*" name="name" id="name" value=""></div>
                        <div class="col-md-12"><input required="required" type="email" placeholder="Email*" name="email" id="email" value=""></div>
                    
                        <div class="col-md-12"><input required="required" type="phone" placeholder="Phone*" class="numbersOnly" value="" name="phone" id="phone"></div>
                        <div class="col-md-12"><input type="text" placeholder="Age" class="numbersOnly" name="age" id="age"></div>
                        ...
                        <div class="col-md-12 form-group">
                            <div class="row align-items-center no-gutters">
                                ...
                                <div class="col-lg-6 col-md-7 mt-2 mt-lg-0 mt-md-0 mb-2 mb-lg-3 mb-md-0">
                        ...
                        <div class="col-md-12"><textarea placeholder="Address" id="address" name="address"></textarea></div>
                    ...
                    <div class="fieldsets row m-0 mt30 pb20 justify-content-center">
                        <div class="col-md-12 p-0">
                            <button type="submit" class="btn btn-solid rounded-pill w-100">Submit</button>
                        </div>
                    </div>
                    <div class="fieldsets row">
                        <div class="col-md-12">
