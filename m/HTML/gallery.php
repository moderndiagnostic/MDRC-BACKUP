...
<body>
    ...
    <header class="header">
        <div class="logo-wrap">
            ...
            <h2 class="fw-bold font-md">Gallery</h2>
        </div>
    </header>
    <!-- Header End -->
    ...
    <main class="main-btm-pd bg-white page-common">
        ...
        <div class="filters filter-button-group">
            <ul>
                ...
                <li><a href="javascript:void(0);" data-filter="laboratory" class="font-md fw-600">National Reference Laboratory</a></li>
                <li><a href="javascript:void(0);" data-filter="labs" class="font-md fw-600">PAN India Labs</a></li>
            </ul>
        </div>
        <div id="container" class="isotope">

            <div class="col-lg-4 col-md-6 grid-item" data-filter="laboratory">
                <a class="popupimg" href="assets/images/mdrc/gallery/img1.jpg">
                    <img src="assets/images/mdrc/gallery/img1.jpg">
                </a>
            ...
            <div class="col-lg-4 col-md-6 grid-item" data-filter="laboratory">
                <a class="popupimg" href="assets/images/mdrc/gallery/img2.jpg">
                    <img src="assets/images/mdrc/gallery/img2.jpg">
                </a>
                <!-- <div class="overlay">Bike</div> -->
            </div>

            <div class="col-lg-4 col-md-6 grid-item" data-filter="laboratory">
                <a class="popupimg" href="assets/images/mdrc/gallery/img3.jpg">
                    <img src="assets/images/mdrc/gallery/img3.jpg">
                </a>
                <!-- <div class="overlay">Bike</div> -->
            </div>


            <div class="col-lg-4 col-md-6 grid-item" data-filter="labs">
                <a class="popupimg" href="assets/images/mdrc/gallery/img4.jpg">
                    <img src="assets/images/mdrc/gallery/img4.jpg">
                </a>
            ...
            <div class="col-lg-4 col-md-6 grid-item" data-filter="labs">
                <a class="popupimg" href="assets/images/mdrc/gallery/img5.jpg">
                    <img src="assets/images/mdrc/gallery/img5.jpg">
                </a>
                <!-- <div class="overlay">Bus</div> -->
            </div>
            ...
            <div class="col-lg-4 col-md-6 grid-item" data-filter="labs">
                <a class="popupimg" href="assets/images/mdrc/gallery/img6.jpg">
                    <img src="assets/images/mdrc/gallery/img6.jpg">
                </a>
                <!-- <div class="overlay">Bus</div> -->
            </div>
