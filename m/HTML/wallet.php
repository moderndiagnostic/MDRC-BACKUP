...
<body>
    ...
    <header class="header">
        <div class="logo-wrap">
            ...
            <h2 class="fw-bold font-md">My Wallet</h2>
        </div>
    </header>
    <!-- Header End -->
    ...
    <main class="main-btm-pd">
            ...
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-start">
                    ...
                    <div class="ms-2">
                        ...
                        <p class="mb-0 th-color-green fw-bold">₹<span>100.50</span></p>
                    </div>
                </div>
        ...
        <div class="bg-white px-3 pt-3 pb-1 border-bottom">
            <div class="d-flex justify-content-between align-items-center pb-2 fw-600">
                <p class="mb-0 fw-600">#6940</p>
                <p class="mb-0">19-Jan</p>
            </div>
            <div class="d-flex justify-content-between align-items-center pb-2 fw-600">
                <p class="mb-0 fw-600">Order Refund for</p>
                <p class="mb-0 th-color-green">+₹<span>100.50</span></p>
            </div>
        </div>
        <div class="bg-white px-3 pt-3 pb-1 border-bottom">
            <div class="d-flex justify-content-between align-items-center pb-2 fw-600">
                <p class="mb-0 fw-600">#6940</p>
                <p class="mb-0">20-Jan</p>
            </div>
            <div class="d-flex justify-content-between align-items-center pb-2 fw-600">
                <p class="mb-0 fw-600">Order Refund for</p>
                <p class="mb-0 th-color-green">+₹<span>100.50</span></p>
        ...
        <div class="bg-white px-3 pt-3 pb-1 border-bottom">
            ...
            <div class="d-flex justify-content-between align-items-center pb-2 fw-600">
                <p class="mb-0 fw-600">Order Paid For</p>
                <p class="mb-0 th-color-red">-₹<span>100.50</span></p>
            </div>
        </div>
        <div class="bg-white px-3 pt-3 pb-1 border-bottom">
            <div class="d-flex justify-content-between align-items-center pb-2 fw-600">
                <p class="mb-0 fw-600">-</p>
                <p class="mb-0">10-Feb</p>
            </div>
            <div class="d-flex justify-content-between align-items-center pb-2 fw-600">
                <p class="mb-0 fw-600">Add in your Wallet</p>
                <p class="mb-0 th-color-green">+₹<span>100.50</span></p>
            </div>
        </div>
        <div class="bg-white px-3 pt-3 pb-1 border-bottom">
            <div class="d-flex justify-content-between align-items-center pb-2 fw-600">
                <p class="mb-0 fw-600">#6952</p>
                <p class="mb-0">02-Feb</p>
            </div>
            <div class="d-flex justify-content-between align-items-center pb-2 fw-600">
                <p class="mb-0 fw-600">Order Refund for</p>
                <p class="mb-0 th-color-green">+₹<span>100.50</span></p>
