...
<body>
    ...
    <header class="header">
        <div class="logo-wrap">
            <a href="wallet.php"><i data-feather="chevron-left"></i></a>
    ...
    <main class="main-btm-pd">
        ...
        <div class="bg-white ">
            <div class="addrupee p-3">
                <a href="" class="th-color-green addbtn ">+₹<span>100.50</span></a>
                <a href="" class="th-color-green addbtn">+₹<span>100.50</span></a>
                <a href="" class="th-color-green addbtn">+₹<span>100.50</span></a>
                <a href="" class="th-color-green addbtn">+₹<span>100.50</span></a>
            </div>
        </div>
        <div class="d-flex justiyf-content-center pt-5 mx-3">
            <a href="" class="btn btn-solid rounded-pill w-100">Add Money</a>
        </div>
    </main>
    <!-- Main End -->
