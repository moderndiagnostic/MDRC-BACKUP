...
<body>
    ...
    <header class="header">
        <div class="logo-wrap">
            ...
            <h2 class="fw-bold font-md">Pay Now</h2>
        </div>
    </header>
    <!-- Header End -->
    ...
    <main class="main-btm-pd bg-white page-common">
        ...
        <div class="card bg-theme rounded-0 border-0 p-3">
            <h2 class="font-lg text-center text-white mb-0">Pay Now</h2>
            ...
            <div class="form-block fdgn2 mt10 mb10">
                <form method="post" id="collection_appointment" name="collection_appointment">
                    <div class="fieldsets row">
                        ...
                        <div class="col-md-12"><input type="text" placeholder="Amount" class="numbersOnly" name="Amount" id="amount"></div>
                        <div class="col-md-12"><textarea placeholder="Message" id="message" name="Message"></textarea></div>

                    <div class="fieldsets row m-0 mt30 pb20 justify-content-center">
                        <div class="col-md-12 p-0">
                            <button type="submit" class="btn btn-solid rounded-pill w-100">Pay Now</button>
                        </div>
                    </div>
                    <div class="fieldsets row">
                        <div class="col-md-12">
