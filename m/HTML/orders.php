...
<body>
    ...
    <header class="header">
        <div class="logo-wrap">
            ...
            <h2 class="fw-bold font-md">My Orders</h2>
        </div>
    </header>
    <!-- Header End -->
    ...
    <main class="main-wrap pt-3 main-btm-pd">
        <!-- Card  -->
        <div class="card mb-3 pb-3 shadow2 d-block">
            <a href="order-details.php" class="ps-3 pe-2 py-2 d-flex align-items-center justify-content-between border-bottom">
                <h3 class="theme-color font-md fw-bold">#MD158</h3>
                <span><i data-feather="chevron-right"></i></span>
            </a>
            <!-- Order Summary -->
            <a href="order-details.php" class="bg-white px-3 pt-3 d-block">
                <div class="d-flex justify-content-between align-items-center pb-2 fw-600">
                    <p class="mb-0">Booking Date</p>
                    <p class="mb-0 fw-600">19-01-2023</p>
                </div>
                <div class="d-flex justify-content-between align-items-center pb-2 fw-600">
                    <p class="mb-0">Payment Type</p>
                    <p class="mb-0 fw-600">COD</p>
                </div>
                <div class="d-flex justify-content-between align-items-center pb-2 fw-600">
                    <p class="mb-0">Status</p>
                    <p class="mb-0 theme-color fw-600">Pending</p>
                </div>
                <div class="d-flex justify-content-between align-items-center">
                    <p class="mb-0 font-md fw-bold">Total Amount</p>
                    <p class="mb-0 font-md fw-600">₹<span>2,800</span></p>
                </div>
            </a>
        </div>
         <!-- Card  -->
