...
<main class="main-wrap mb-xxl pt-3">
    <section>
	...
	<section>
		<form method="post" action="" name="teamSearchForm" class="teamSearchForm">
			...
			<input type="hidden" name="employeeID" value="<?=$this->getGetVar('employeeID'); ?>" />
			<input type="hidden" name="level" value="<?php echo !empty($this->getGetVar('level'))?$this->getGetVar('level'):0; ?>" />

			<input type="hidden" name="login_lms_employee_id" value="<?= $this->employee['lms_employee_id']; ?>" />
			<input type="hidden" name="login_lms_employee_code" value="<?= $this->employee['lms_employee_code']; ?>" />

            <input type="hidden" name="selectEmployeeId" value="<?php echo $this->employee['id']; ?>" />
            <input type="hidden" name="selectEmployeeLmsId" value="<?php echo $this->employee['lms_employee_id']; ?>" />
		</form>
...
$(document).ready(function() {
    ...
    $("#loadMore").click(function() {
        ...
        loadTeamList(); // Load next set of data
    });
