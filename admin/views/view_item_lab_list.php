    ...
    <div class="container">
      <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
        <div>
          ...
          <h3 class="mg-b-0 tx-spacing--1">Lab</h3>
        </div>
        <div class="">
          <button class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5 item_lab_addedit_onclick" data-id=""><i data-feather="plus" class="wd-10 mg-r-5" ></i> Add New</button>
          <button class="btn btn-sm pd-x-15 btn-white btn-uppercase mg-l-5" onclick="mulitple_item_lab_select();"><i data-feather="trash" class="wd-10 mg-r-5"></i> Delete</button>
        </div>
      </div>
<!--      <p class="mg-b-30">Sytem accept only order of below Manufacturer.</p>
-->      <div data-label="All Brand" class="df-example demo-table">
        <table id="table_item_lab" class="table">
          <thead>
            <tr>
...
<script src="scripts/js/item_lab.js"></script> 
