  ...
  <div class="content-body">
    <div class="container">
        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb df-breadcrumbs mg-b-10">
              ...
              <li class="breadcrumb-item active" aria-current="page">User Cart Notification Logs</li>
            </ol>
          </nav>
          <h3 class="mg-b-0 tx-spacing--1">User Cart Notification Logs</h3>
        </div>
      </div>
      ...
      <div data-label="All Cart List" class="df-example demo-table">
        <table id="table_user_cart_notification" class="table">
          <thead>
            <tr>
...
<script src="scripts/js/user_cart_notification_list.js?v=1.5"></script> 
