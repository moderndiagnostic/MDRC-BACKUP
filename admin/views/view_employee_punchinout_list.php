    ...
    <div class="container">
        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb df-breadcrumbs mg-b-10">
              ...
              <li class="breadcrumb-item active" aria-current="page">Employee Punch in-out</li>
            </ol>
          </nav>
          <h3 class="mg-b-0 tx-spacing--1">Employee Punch in-out</h3>
        </div>
        <div class="">
      ...
      <div class="df-example datatable-menu-tab">
        <ul class="nav justify-content-left">
          ...
          <li class="nav-item"> <a class="nav-link tab_link" href="javascript:void(0)">Punch In but Not Puch Out</a></li>
          <input type="hidden" name="tab_filter" id="tab_filter" value="">
        </ul>
      </div>
      <div class="df-example demo-table">
        <table id="table_employee_punchinout" class="table">
          <thead>
            <tr>
              <!-- <th class="wd-5p">
              ...
              <th class="wd-10p">In</th>
              <th class="wd-10p">Out</th>
...
<script src="scripts/js/employee_punchinout.js<?=ALLVERSION ?>"></script>
