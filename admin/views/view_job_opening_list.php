        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb df-breadcrumbs mg-b-10">
              <li class="breadcrumb-item"><a href="javascript:void(0)">Manage Job</a></li>
              <li class="breadcrumb-item active" aria-current="page">Job Opening</li>
            </ol>
          </nav>
          <h3 class="mg-b-0 tx-spacing--1">Job Opening</h3>
        </div>
        <div class="d-none d-md-block">
          <button class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5 job_opening_addedit_onclick" data-id=""><i data-feather="plus" class="wd-10 mg-r-5" ></i> Add New</button>
          <button class="btn btn-sm pd-x-15 btn-white btn-uppercase mg-l-5" onclick="mulitple_job_opening_select();"><i data-feather="trash" class="wd-10 mg-r-5"></i> Delete</button>
        </div>
      </div>
      <!--<p class="mg-b-30">Sytem accept only order of below job_opening.</p>-->
      <div data-label="All Job Opening" class="df-example demo-table">
        <table id="table_job_opening" class="table">
          <thead>
            <tr>
              ...
              <th class="wd-15p">No Of Opening</th>
...
<script src="scripts/js/job_opening.js"></script>
