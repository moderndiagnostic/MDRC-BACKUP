    ...
    <div class="container">
      <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
        <div>
          ...
          <h3 class="mg-b-0 tx-spacing--1">Information Pages</h3>
        </div>
        
        <div class="d-none d-md-block">
	 
    <a href="index.php?view=pages_addedit" class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5"><i data-feather="plus" class="wd-10 mg-r-5" ></i> Add New</a>
	
          <button class="btn btn-sm pd-x-15 btn-white btn-uppercase mg-l-5" onclick="mulitple_pages_select();"><i data-feather="trash" class="wd-10 mg-r-5"></i> Delete</button>
        </div>
      </div>
       <?=$this->utility->get_message()?>
     <!-- <p class="mg-b-30">Sytem accept only order of below pages.</p>-->
      <div data-label="All Pages" class="df-example demo-table">
        <table id="table_pages" class="table">
          <thead>
            <tr>
