        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb df-breadcrumbs mg-b-10">
              ...
              <li class="breadcrumb-item active" aria-current="page">For Doctors</li>
            </ol>
          </nav>
          <h3 class="mg-b-0 tx-spacing--1">For Doctors</h3>
        </div>
        <div class="d-none d-md-block">
          <button class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5 for_doctors_addedit_onclick" data-id=""><i data-feather="plus" class="wd-10 mg-r-5" ></i> Add New</button>
          <button class="btn btn-sm pd-x-15 btn-white btn-uppercase mg-l-5" onclick="mulitple_for_doctors_select();"><i data-feather="trash" class="wd-10 mg-r-5"></i> Delete</button>
        </div>
      </div>
      <!--<p class="mg-b-30">Sytem accept only order of below for_doctors.</p>-->
      <div data-label="All For Doctors" class="df-example demo-table">
        <table id="table_for_doctors" class="table">
          <thead>
            <tr>
              ...
              <th class="wd-10p">Set At Home</th>
...
<script src="scripts/js/for_doctors.js"></script>
