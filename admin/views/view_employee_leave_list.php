  ...
  <div class="content-body">
    <div class="container">
      <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
        <div>
          <h3 class="mg-b-0 tx-spacing--1">Employee Leave</h3>
        </div>
        <div class="">
        </div>
      </div>
      ...
      <div class="df-example datatable-menu-tab">
        <ul class="nav justify-content-left">
          ...
          <li class="nav-item"> <a class="nav-link tab_link" href="javascript:void(0)">Approved</a></li>
          <li class="nav-item"> <a class="nav-link tab_link" href="javascript:void(0)">Reject</a></li>
          <input type="hidden" name="tab_filter" id="tab_filter" value="">
        </ul>
      </div>
      <div class="df-example demo-table">
        <table id="table_employee_leave" class="table">
          <thead>
            <tr>
              <th class="wd-5p">Id</th>
              <th class="wd-15p">Employee</th>
              <th class="wd-10p">Leave Start</th>
              <th class="wd-10p">Leave End</th>
...
<script src="scripts/js/employee_leave.js<?=ALLVERSION ?>1"></script>
