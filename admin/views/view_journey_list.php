  ...
  <div class="content-body">
    <div class="container">
      <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
        <div>
          <h3 class="mg-b-0 tx-spacing--1">Logistic Confirmation List</h3>
        </div>
        <div class="">
      ...
      <div class="df-example datatable-menu-tab">
        <ul class="nav justify-content-left">
          ...
          <li class="nav-item"> <a class="nav-link tab_link" href="javascript:void(0)">Running</a></li>
          <li class="nav-item"> <a class="nav-link tab_link" href="javascript:void(0)">Pending</a></li>
          <li class="nav-item"> <a class="nav-link tab_link" href="javascript:void(0)">Approve By Manager</a></li>
          <li class="nav-item"> <a class="nav-link tab_link" href="javascript:void(0)">Approve By Finance</a></li>
          <li class="nav-item"> <a class="nav-link tab_link" href="javascript:void(0)">Reject By Manager</a></li>
          <li class="nav-item"> <a class="nav-link tab_link" href="javascript:void(0)">Reject By Finance</a></li>
          <input type="hidden" name="tab_filter" id="tab_filter" value="">
        </ul>
      </div>
      
      <div class="df-example demo-table">
        <table id="table_journey" class="table">
          <thead>
            <tr>
              <th>Id</th>
              <th>Employee</th>
...
<script src="scripts/js/journey.js<?=ALLVERSION ?>"></script>
<script>
$(function(){
'use strict'
