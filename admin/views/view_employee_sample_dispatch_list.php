    ...
    <div class="container">
        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb df-breadcrumbs mg-b-10">
              ...
              <li class="breadcrumb-item active" aria-current="page">Sample Dispatch list</li>
            </ol>
          </nav>
          <h3 class="mg-b-0 tx-spacing--1">Sample Dispatch List</h3>
        </div>
        <div class="">
      ...
      <div class="df-example datatable-menu-tab">
        <ul class="nav justify-content-left">
          ...
          <li class="nav-item"> <a class="nav-link tab_link" href="javascript:void(0)">Delivered</a></li>
          <li class="nav-item"> <a class="nav-link tab_link" href="javascript:void(0)">Dispatched</a></li>
          <input type="hidden" name="tab_filter" id="tab_filter" value="">
        </ul>
      </div>
      <div class="df-example demo-table">
        <table id="table_employee_sample_dispatch" class="table">
          <thead>
            <tr>
              <!-- <th class="wd-5p">
              ...
              <th class="wd-15p">Sent To.</th>
              <th class="wd-15p">Courier</th>
              <th class="wd-15p">Sent By.</th>
              <th class="wd-10p">Received By.</th>
...
<script src="scripts/js/employee_sample_dispatch.js<?=ALLVERSION ?>"></script>
