        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb df-breadcrumbs mg-b-10">
              ...
              <li class="breadcrumb-item active" aria-current="page">IPO Pdfs</li>
            </ol>
          </nav>
          <h3 class="mg-b-0 tx-spacing--1">IPO Pdfs</h3>
        </div>
        <div class="d-none d-md-block">
          <button class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5 ipo_pdfs_addedit_onclick" data-id=""><i data-feather="plus" class="wd-10 mg-r-5" ></i> Add New</button>
          <button class="btn btn-sm pd-x-15 btn-white btn-uppercase mg-l-5" onclick="mulitple_ipo_pdfs_select();"><i data-feather="trash" class="wd-10 mg-r-5"></i> Delete</button>
        </div>
      </div>
      <div data-label="All IPO Pdfs" class="df-example demo-table">
        <table id="table_ipo_pdfs" class="table">
          <thead>
            <tr>
              ...
              <th class="wd-10p">Pdf</th>
              <th class="wd-10p">Page Type</th>
              <th class="wd-10p">QR Code</th>
...
<script src="scripts/js/ipo_pdfs.js?v=1"></script>
