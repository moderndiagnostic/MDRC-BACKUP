  ...
  <div class="content-body">
    <div class="container">
      <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
        <div>
          <h3 class="mg-b-0 tx-spacing--1">Employee List</h3>
        </div>
        <div class="">
          <a class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5 employee_addedit_onclick" data-id='' href="javascript:void(0)"><i data-feather="plus" class="wd-10 mg-r-5"></i> Add New</a>
          <?php if($this->rs_admin['employee_role']=='Admin') { ?>
          <button class="btn btn-sm pd-x-15 btn-warning btn-uppercase mg-l-5 employee_lms_sync"><i data-feather="cloud-rain" class="wd-10 mg-r-5"></i> SYNC with LMS</button>
          <?php } ?>
        </div>
      </div>
      ...
      <div data-label="Search" class="df-example demo-table" >
        ...
        <div class="row">
          ...
          <div class="form-group col-md-4" >
            ...
            <? $this->htmlBuilder->buildTag("select", array("class"=>"form-select select2 w-100","id"=>"designation_id","name"=>"designation_id","values"=>[''=>'Select']+$this->designation), "") ?>
          </div>
      ...
      <div class="df-example datatable-menu-tab">
        <ul class="nav justify-content-left">
          ...
          <li class="nav-item"> <a class="nav-link tab_link" href="javascript:void(0)">All In LMS</a></li>
          <li class="nav-item"> <a class="nav-link tab_link" href="javascript:void(0)">Not In LMS</a></li>
          <input type="hidden" name="tab_filter" id="tab_filter" value="">
        </ul>
      </div>
      
      <div class="df-example demo-table">
        <table id="table_employee" class="table">
          <thead>
            <tr>
              <th class="wd-5p">Id</th>
              <th class="wd-15p">Name</th>
              <th class="wd-10p">Contact</th>
              <th class="wd-10p">Reporting</th>
...
<script src="scripts/js/employee.js<?=ALLVERSION ?>"></script>
