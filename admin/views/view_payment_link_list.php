  ...
  <div class="content-body">
    <div class="container">
      <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
        <div>
          <h3 class="mg-b-0 tx-spacing--1">Payment Links</h3>
        </div>
        <div class="">
        <a class="btn btn-sm pd-x-15 btn-warning btn-uppercase mg-l-5" href="index.php?view=payment_link_list&act=export_data"><i data-feather="download" class="wd-10 mg-r-5"></i> Export</a>
      ...
      <div data-label="All Payment Link" class="df-example demo-table">
...
<script src="scripts/js/payment_link.js"></script> 
