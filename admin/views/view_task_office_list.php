  ...
  <div class="content-body">
    <div class="container">
        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb df-breadcrumbs mg-b-10">
              ...
              <li class="breadcrumb-item active" aria-current="page">Office Task</li>
            </ol>
          </nav>
          <h3 class="mg-b-0 tx-spacing--1">Office Task</h3>
        </div>
        <div class="">
      ...
      <div class="df-example demo-table">
        <table id="table_task_office" class="table">
          <thead>
            <tr>
...
<script src="scripts/js/task_office.js<?=ALLVERSION ?>"></script>
