    ...
    <div class="container">
        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb df-breadcrumbs mg-b-10">
              <li class="breadcrumb-item"><a href="javascript:void(0)">Logistic</a></li>
              <li class="breadcrumb-item active" aria-current="page">Sample Pickup list</li>
            </ol>
          </nav>
          <h3 class="mg-b-0 tx-spacing--1">Sample Pickup List</h3>
        </div>
        <div class="">
           <a class="btn btn-sm pd-x-15 btn-warning btn-uppercase mg-l-5 employee_sample_pickup_export" href="javascript:void(0)"><i data-feather="plus" class="wd-10 mg-r-5"></i> Export</a>
        </div>
      </div>
      ...
      <div class="df-example datatable-menu-tab">
        <ul class="nav justify-content-left">
          ...
          <li class="nav-item"> <a class="nav-link tab_link" href="javascript:void(0)">Pending</a></li>
          <li class="nav-item"> <a class="nav-link tab_link" href="javascript:void(0)">In Progress</a></li>
      ...
      <div class="df-example demo-table">
        <table id="table_employee_sample_pickup" class="table">
          <thead>
            <tr>
              <!-- <th class="wd-5p">
              ...
              <th class="wd-10p">Pickup</th>
              <th class="wd-15p">Summary</th>
...
<script src="scripts/js/employee_sample_pickup.js<?=ALLVERSION ?>1"></script>
