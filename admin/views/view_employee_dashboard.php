  ...
  <div class="content-body">
    <div class="pd-x-0">
      <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
        <div>
          <h4 class="mg-b-0 tx-spacing--1">Team Work Dashboard</h4>
        </div>
        <div class="d-md-block"> <a href="javascript:void(0)" data-url="index.php?view=employee_dashboard&act=export_data" class="btn btn-sm pd-x-15 btn-warning btn-uppercase export"><i data-feather="download" class="wd-10 mg-r-5"></i>Export Data</a></div>
      </div>
                  ...
                  <div class="col-12">
                    <div class="row g-3 mb-3 ">
                      ...
                      <div class="col-sm-12 col-lg-12 mg-t-10 mg-b-10 selectedEmployeeCard" style="display:none">
                       ...
                       <div class="col-sm-12 col-lg-12 mg-t-10 mg-b-10 selectedEmployeeTeamCard" style="display:none">
                        <div class="card">
                          <div class="card-header">
                            <div class="tx-16 d-flex justify-content-between align-items-center">
                              <h5 class="mg-b-0 text-green fw-bold selectedEmployeeTeamName"></h5>
                              <button type="button" class="btn-close" onclick="closeSubEmployee()">
                                  <span aria-hidden="true">X</span>
                              </button>
                            </div>
                          ...
                          <div class="card-body shadow-sm p-4">
                            <div class="row align-items-center">
                              ...
                              <div class="col-md-4">
                                <div class="chart-seven" style="width: 100%; height: 280px;">
                                  <canvas class="w-100 h-100" id="chartDonut4"></canvas>
                                </div>
                              </div>
                              <!-- Task Data Section -->
                              <div class="col-md-8">
                                <div class="row taskHtml5">
                                  <!-- append html here -->
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="col-sm-12 col-lg-12 mg-t-10 mg-b-10">
                        <div class="card">
                          <div class="card-header">
                            <div class="tx-16 d-flex justify-content-between align-items-center">
                              <h5 class="mg-b-0 text-green fw-bold"><?= $this->employee['name'] ?> Tasks</h5>
                            </div>
                          </div>
                          <div class="card-body shadow-sm p-4">
                            <div class="row align-items-center">
                      ...
                      <div class="col-sm-12 col-lg-12 mg-t-10 mg-b-10">
                        <div class="card">
                          <div class="card-header">
                            <div class="tx-16 d-flex justify-content-between align-items-center">
                              <h5 class="mg-b-0 text-green fw-bold">All Team Tasks</h5>
                            </div>
                          </div>
                          <div class="card-body shadow-sm p-4">
                            <div class="row align-items-center">
...
<script src="scripts/js/employee_dashboard.js<?= ALLVERSION ?>"></script>
<script>
  $(function() {
    'use strict'
