...
<link href="lib/selectdropdown/jquery-ui.min.css" rel="stylesheet">
<!-- DashForge CSS -->
        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb df-breadcrumbs mg-b-10">
              <li class="breadcrumb-item"><a href="javascript:void(0)">Manage Notification</a></li>
              <li class="breadcrumb-item active" aria-current="page">Notification</li>
            </ol>
          </nav>
          <h3 class="mg-b-0 tx-spacing--1">Notification</h3>
        </div>
        <div class="d-none d-md-block">
          <button class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5 push_notification_addedit_onclick" data-id=""><i data-feather="plus" class="wd-10 mg-r-5" ></i> Add New</button>
          <button class="btn btn-sm pd-x-15 btn-white btn-uppercase mg-l-5" onclick="mulitple_push_notification_select();"><i data-feather="trash" class="wd-10 mg-r-5"></i> Delete</button>
        </div>
      </div>
      <!--<p class="mg-b-30">Sytem accept only order of below push_notification.</p>-->
      <div data-label="All Notification" class="df-example demo-table">
        <table id="table_push_notification" class="table">
          <thead>
            <tr>
...
<script src="scripts/js/push_notification.js?v=1.1"></script>
<script src="lib/selectdropdown/jquery-ui.min.js"></script>