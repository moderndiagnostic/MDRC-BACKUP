        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb df-breadcrumbs mg-b-10">
              <li class="breadcrumb-item"><a href="javascript:void(0)">Manage Setting</a></li>
              <li class="breadcrumb-item active" aria-current="page">Page Description</li>
            </ol>
          </nav>
          <h3 class="mg-b-0 tx-spacing--1"><?=$this->page_name?></h3>
        </div>
        <div class="d-none d-md-block">
          <button class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5 page_desc_addedit_onclick" data-page_info_id="<?=$this->pageInfoId?>" data-id=""><i data-feather="plus" class="wd-10 mg-r-5" ></i> Add New</button>
          <button class="btn btn-sm pd-x-15 btn-white btn-uppercase mg-l-5" onclick="mulitple_page_desc_select();"><i data-feather="trash" class="wd-10 mg-r-5"></i> Delete</button>
        </div>
      </div>
      <input type="hidden" id="page_info_id" value="<?=$this->pageInfoId?>">
     
      <div data-label="All Meta" class="df-example demo-table">
        <table id="table_page_desc" class="table">
          <thead>
            <tr>
              ...
              <th class="wd-30p">Created Date</th>
...
<script src="scripts/js/page_desc.js?v=1"></script>
