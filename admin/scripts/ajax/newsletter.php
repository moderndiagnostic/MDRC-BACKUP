...
if($get_actionType=="newsletter_list")

{

	$table_name='newsletter_receiver';
...

	{
		...
		registration_date like '%".$searchValue."%'
...
if($actionType=="newsletterDelete")

{
...

	{
		...
		$obj_change_table = $app->load_model('newsletter_receiver');
...
if($actionType=="newsletterMultiDelete")
