...
if($get_actionType=="get_tuch_inq_list")

{

	$table_name='get_call_back';
...

	{
			...
			$delete_btn='<button type="button" class="btn btn-xs btn-danger btn-icon get_tuch_inq_delete_onclick" data-id="'.$result[$i]['id'].'" ><i class="fas fa-trash"></i></button>';				
...
if($actionType=="get_tuch_inqDelete")

{
...

	{
		...
		$obj_change_table = $app->load_model('get_call_back');
