...
if($get_actionType=="collection_appointment_list")

{

	$table_name='collection_appointment';
...

	{
		...
		(
			...
			"brief_details"=>$result[$i]['brief_details'],
...
if($actionType=="collection_appointmentDelete")

{
...

	{
		...
		$obj_change_table = $app->load_model('collection_appointment');
