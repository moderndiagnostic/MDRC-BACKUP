...
//Function for active order_cancellation_report datatbale loading
if($get_actionType=="order_cancellation_report_list")
{
	...
	$rs_orders = $obj_model_cancelled->execute("SELECT", false, "", "order_status='Canceled' ".$search_end_date_cond."");
	...
	$obj_model_cancelled->join_table("order_shipping_address", "left", array(), array("id"=>"order_master_id"));
	//$obj_model_cancelled->join_table("invoice", "left", array(), array("id"=>"order_master_id"));
	$result = $obj_model_cancelled->execute("SELECT", false, "", "order_status='Canceled' ".$search_end_date_cond."");		
	...
	$obj_model_cancelled->join_table("order_shipping_address", "left", array(), array("id"=>"order_master_id"));
	//$obj_model_cancelled->join_table("invoice", "left", array(), array("id"=>"order_master_id"));
	$result = $obj_model_cancelled->execute("SELECT", false, "", "order_status='Canceled' ".$search_end_date_cond." ".$searchQuery."");
	...
	$obj_model_cancelled->join_table("order_shipping_address", "left", array(), array("id"=>"order_master_id"));
	//$obj_model_cancelled->join_table("invoice", "left", array(), array("id"=>"order_master_id"));
	$result = $obj_model_cancelled->execute("SELECT", false, "", "order_status='Canceled' ".$search_end_date_cond." ".$searchQuery."","order_master.id DESC limit ".$row.",".$rowperpage."");
