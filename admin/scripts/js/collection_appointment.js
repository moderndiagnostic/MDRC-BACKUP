...
$(document).ready(function(){
	...
	$('#table_collection_appointment').DataTable({
		...
		'ajax': {
			...
			'url':'scripts/ajax/index.php?method=collection_appointment&actionType=collection_appointment_list',
...

			{
...

				{
...

					{
						  ...
						  data: "method=collection_appointment&actionType=collection_appointmentDelete&getid="+getid,
...

						  {
...

								  {
									...
									var oTable = $('#table_collection_appointment').dataTable( );
