...
$(document).ready(function(){
	...
	$('#table_gallery').DataTable({
		...
		'ajax': {
			...
			'url':'scripts/ajax/index.php?method=gallery_images&actionType=gallery_images_list&cat_id='+cat_id,
...

			{
...

				{
...

					{
						  ...
						  data: "method=gallery_images&actionType=galleryDelete&getid="+getid,
					...
					function (r){
						...
						if(r == true)

						  {
							  ...
							  data: "method=gallery_images&actionType=galleryMultiDelete&ids="+ids,
