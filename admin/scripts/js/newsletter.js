...
$(document).ready(function(){
	...
	$('#table_newsletter').DataTable({
		...
		'ajax': {
			...
			'url':'scripts/ajax/index.php?method=newsletter&actionType=newsletter_list',
...

			{
...

				{
...

					{
						  ...
						  data: "method=newsletter&actionType=newsletterDelete&getid="+getid,
...

						  {
...

								  {
									...
									var oTable = $('#table_newsletter').dataTable( );
...
function mulitple_newsletter_select()
					...
					function (r){
						...
						if(r == true)

						  {
							  ...
							  data: "method=newsletter&actionType=newsletterMultiDelete&ids="+ids,
