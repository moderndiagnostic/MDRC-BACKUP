...
$(document).ready(function(){
	$('#table_task').DataTable({
		...
		'serverMethod': 'post',
		'ajax': {
			'url':'scripts/ajax/index.php?method=task&actionType=task_list',
			"data": function(d) {
				d.start_date = $('#start_date').val();
				d.end_date = $('#end_date').val();
				d.tab_filter = $('#tab_filter').val();
				d.actionType = "task_list";     
			  },
		},
		'columns': [
		  	{ "data": "id" },
...
$(document).on("click",".export", function ()
{
	...
	{
		var link="index.php?view=task_list&act=downloadTask&start_date="+start_date+"&end_date="+end_date;
		$(this).attr('href', link);
		$(this).trigger( "click" );
		return false;
	}
