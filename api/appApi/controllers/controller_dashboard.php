...
class _dashboard extends controller{
	...
	function onload()
	{
		...
		$otherBanner[]=["imageType"=>"howItWork","actionType"=>"","actionID"=>"","image"=>IMAGE_SERVER_ROOT.'/uploads/otherBanner/how_it_work_image.png'];
		$otherBanner[]=["imageType"=>"certificate","actionType"=>"","actionID"=>"","image"=>IMAGE_SERVER_ROOT.'/uploads/otherBanner/accreditation1.png'];
		$otherBanner[]=["imageType"=>"bottomImage","actionType"=>"","actionID"=>"","image"=>IMAGE_SERVER_ROOT.'/uploads/otherBanner/dashboard_bottom_banner.png'];


		$aboutInfo[]=["name"=>"20 Labs Across 7 State","image"=>IMAGE_SERVER_ROOT.'/uploads/aboutInfo/features.png'];
		$aboutInfo[]=["name"=>"1800+ Touch Points Across India","image"=>IMAGE_SERVER_ROOT.'/uploads/aboutInfo/touch-points.png'];
		$aboutInfo[]=["name"=>"International Reach","image"=>IMAGE_SERVER_ROOT.'/uploads/aboutInfo/international.png'];
		$aboutInfo[]=["name"=>"38+ Year of\nExperience","image"=>IMAGE_SERVER_ROOT.'/uploads/aboutInfo/experience.png'];
