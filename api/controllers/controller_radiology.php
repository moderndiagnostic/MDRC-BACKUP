...
class _radiology extends controller{
	...
	function onload(){
		...
		$rs_banner=$obj_model_banner->execute("SELECT",false,"","status='Active' and FIND_IN_SET ('radiology',banner.show_page) and (FIND_IN_SET ('".$_SESSION['cityID']."',banner.city_ids) or city_ids='')","sort_id ASC");
