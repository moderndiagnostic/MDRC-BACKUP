...
<main class="h-100vh overflow-auto">
    ...
    <div class="d-flex align-items-center bg-theme p-3" style="background: #ffcbcb;">
        <img src="assets/images/mdrc/img/icon-fail.png" alt="" class="img-fluid wd-50 ht-50">
        <p class="mb-0 font-md fw-bold ms-3">Your Booking payment is failed!</p>
    </div>
