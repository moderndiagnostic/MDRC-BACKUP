...
<main class="pb-4 bg-white page-common">
	...
	<div class="card bg-theme rounded-0 border-0">
		<div>
			<img src="https://www.mdrcindia.com/images/investor-relation/ipo-banner.png" alt="" class="w-100 h-100 img-fluid">
		</div>
	</div>
	<!-- About banner end -->
	
	<!-- About tab start -->
	<div class="about-tab mb-3 mt-3">
		<h2 class="font-lg text-center mb-3">IPO / Offer Documents</h2>
