...
?>
<!-- The Modal -->
<div class="coup-modal check-apply-coupon offcanvas offcanvas-bottom common-popup" tabindex="-1" id="coupon-modal" aria-labelledby="coupon-modal">
<div class="offcanvas-header">
					<div class="d-flex align-items-center justify-content-between w-100">
						<h3 class="fw-600">Apply Coupons</h3>
						<div class="btnclose">
				...
				<!-- Modal body -->			
					<div class="form-block fdgn2 mt10 mb10">
						<form class="" id="promo_code_form" name="promo_code_form" method="post" action="">
							<div class="fieldsets row m-auto g-0">
								<div class="col-md-12 mb-3 mt-2 space_coupon position-relative">
									<input class="required m-0 form-control" type="text" id="coupon_code" name="coupon_code" placeholder="Enter coupon code">
					...
					<?php if (count($rs_coupon) > 0) { ?>
						...
						<div class="fieldsets row m-auto pt-3 pb-3">
							...
							<div class="col-lg-6 col-6">
								<button type="button" class="btn-solid text-uppercase w-100 appyCouponBtn" id="appyCouponBtn">Apply</button>
							</div>
