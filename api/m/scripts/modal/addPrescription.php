		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body  ">
					<div class="col-lg-12  text-center col-12 mt-4">
						...
						<form action="" method="post" name="preForm" id="preForm" enctype="multipart/form-data">
										...
										<div class="preview-zone hidden">
											<div class="box box-solid">
												<div class="box-header with-border">
													<div><b>Preview</b></div>
													<div class="box-tools pull-right mt-1">
							...
							<div class="row">
								<div class="col-md-12 mt-4">
									<button type="submit" class="btn-solid lnk btn-main bg-btn w-auto float-end item_modal_submit">Upload</button>
								</div>
							</div>
							<div class="row">
