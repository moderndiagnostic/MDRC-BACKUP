<?php
	class model_item_department{
		...
		function model_item_department($ID=0){
			$this->ID = $ID;
			$this->KEY = "id";
			...
			$this->fields["home_collection"]="enum('Yes','No')";
			$this->nullable["home_collection"]="NO";
			$this->default_value["home_collection"]="No";
			$this->fields["lab_selection"]="enum('Yes','No')";
			$this->nullable["lab_selection"]="NO";
			$this->default_value["lab_selection"]="No";
		}
	}
?>