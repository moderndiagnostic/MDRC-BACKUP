<?php
	class model_test_booking_enquiry{
		public $fields= array();
		...
		function model_test_booking_enquiry($ID=0){
			$this->ID = $ID;
			$this->KEY = "id";
			...
			$this->fields["file"]="varchar(255)";
			$this->nullable["file"]="YES";
			$this->default_value["file"]="";
			$this->fields["user_id"]="int(11)";
			$this->nullable["user_id"]="YES";
			$this->default_value["user_id"]="";

			$this->fields["enquiry_type"]="enum('New Booking','Customer Support Query')";
			$this->nullable["enquiry_type"]="YES";
			$this->default_value["enquiry_type"]="New Booking";

			$this->fields["test_type"]="enum('Blood Test','MRI/CT Scan Etc')";
			$this->nullable["test_type"]="YES";
			$this->default_value["test_type"]="Blood Test";
