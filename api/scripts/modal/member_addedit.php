              ...
              <div class="fieldsets row ">
                <div class="col-md-6 col-6">
                	<label>Date Of Birth *</label>
		              <? $app->htmlBuilder->buildTag("input", array("type"=>"date","class"=>"required","value"=>$dob,"onchange"=>"calculateage(this.value)"), "dob") ?>
                </div>
                <!-- <div class="col-md-3 col-6">
                	<label>Age</label> -->
		             <? $app->htmlBuilder->buildTag("input", array("type"=>"hidden","class"=>"numbersOnly numbers","value"=>$age,"maxlength"=>"3","minlength"=>"1","readonly"=>""), "age") ?>
                <!-- </div> -->
