				...
				<div class="custom-nav" role="navigation">
					<ul class="nav-list onepge">
						...
						<li class="call-text" style="margin-left:10px">
							<a href="tel:<?php echo !empty($_SESSION['cityPhone'])?$_SESSION['cityPhone']:'+91-124-6712000';?>" class="">CALL US <br/><span><?php echo !empty($_SESSION['cityPhone'])?$_SESSION['cityPhone']:'+91-124-6712000';?></span></a>
						</li>
					</ul>
				</div>
			</div>
