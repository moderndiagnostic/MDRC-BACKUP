...
<div class="watsap_links">
	...
	<a class="wtsapp-desktop" href="https://web.whatsapp.com/send?phone=918586988847&amp;text=Hello :) Thank you for contacting Modern Diagnostic and Research Centre. How can we help you please?" target="_blank"><img src="images/whatsapp_i.png" alt="best diagnostic centre" /></a>
			...
			<div class="col-lg-9 custim col-12 ft text-center">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-4 ft text-center">
					   ...
					   <a data-bs-toggle="modal" data-bs-target="#modalform-full"><em class="FxdBtn-Icn"><i class="fas fa-pencil-alt"></i></em>Book a Lab Test </a>

					</div>

					<div class="col-lg-4 col-4 sd">

					   <a href="javascript:void(0)" class="report-top"> <em class="FxdBtn-Icn"><i class="far fa-file-alt"></i></em>Download reports  </a>

					</div>

					<div class="col-lg-4 col-4 td">

					   <a href="contact-us.html"> <em class="FxdBtn-Icn"><i class="fas fa-comment-dots"></i></em>Chat with our health Agent  </a>
			...
			<div class="row">
				...
				<div class="col-lg-2 col-md-3 col-5">
					...
					<div class="email-subs">
						...
						<div class="footer-social-media-icons">
							...
							<a href="javascript:void(0)" target="blank"><i class="fab fa-facebook-f"></i></a>

							<a href="javascript:void(0)" target="blank"><i class="fab fa-instagram"></i></a>

							<a href="javascript:void(0)" target="blank"><i class="fab fa-linkedin-in"></i></a>
				...
				<div class="col-lg-4 col-md-4 col-7">
					...
					<div class="email-subs">
						...
						<h5 class="text-white">Chat on Whatsapp</h5>

						<a class="tel" href="tel:911246712000">+91-124-6712000</a>
		...
		<div class="container">
			...
			<div class="row justify-content-between">
				...
				<div class="col-lg-4 col-sm-6  ftr-brand-pp">
					...
					<a class="navbar-brand  mb25 f-dark-logo" href="#"> <img src="images/logo.png" alt="Logo"/></a>

					<a class="navbar-brand mt30 mb25 f-white-logo" href="#"> <img src="images/white-logo.png" alt="Logo" /></a>

					<p>Modern Diagnostic & Research Centre Labs (unit of US based Modern Diagnostic & Research Centre Pvt. Ltd.) is India's fastest growing technology empowered diagnostics service provider having its home sample collection service in more than 120 cities with 30+ Labs and 700+ Walk-in Wellness and Collection Centres across India.</p>
				...
				<div class="col-lg-2 col-sm-6">
					...
					<ul class="footer-address-list link-hover">
						...
						<li><a href="javascript:void(0)">Cytogenetics</a></li>

						<li><a href="javascript:void(0)">Histopathology & Cytopathology</a></li>

						<li><a href="javascript:void(0)">Microbiology</a></li>

						<li><a href="javascript:void(0)">Hematology And Coagulation</a></li>

						<li><a href="javascript:void(0)">Biochemistry</a></li>
				...
				<div class="col-lg-3 col-sm-6 footer-blog-">
					...
					<ul class="footer-address-list link-hover">
						...
						<li><a href="javascript:void(0)">Smart Full Body Checkup</a></li>

						<li><a href="javascript:void(0)">Kidney Function Test</a></li>

						<li><a href="javascript:void(0)">Liver Function Test</a></li>

						<li><a href="javascript:void(0)">Covid - 19 RTPCR</a></li>

						<li><a href="javascript:void(0)">Advance Full Body Checkup</a></li>

						<li><a href="javascript:void(0)">Healthy Heart Package</a></li>

						<li><a href="javascript:void(0)">Blood Sugar Test</a></li>
			...
			<div class="row">
				...
				<div class="col-lg-12 mt80 col-sm-12">
					...
					<a class="tags" href="#">Smart Full Body <span>+</span></a>

					<a class="tags" href="#">Pcos Basic Screening <span>+</span></a>

					<a class="tags" href="#">Blood Sugar Test <span>+</span></a>

					<a class="tags" href="#">Arthritis Profile Test <span>+</span></a>

					<a class="tags" href="#">CBC Test <span>+</span></a>

					<a class="tags" href="#">STD Testing<span>+</span></a>
					...
					<a class="tags" href="#">ESR Test <span>+</span></a>

					<a class="tags" href="#">Cholesterol Test <span>+</span></a>

					<a class="tags" href="#">Triple Maker Test <span>+</span></a>

					<a class="tags" href="#">Diabetes Screening <span>+</span></a>

					<a class="tags" href="#">Liver Function Test (LFT) <span>+</span></a>

					<a class="tags" href="#">Creatinine Test <span>+</span></a>

					<a class="tags" href="#">Vitamin D Test <span>+</span></a>
					...
					<a class="tags" href="#">Kidney Function Test (KFT) <span>+</span></a>

					<a class="tags" href="#">Vitamin B12 Test <span>+</span></a>

					<a class="tags" href="#">CPR Test (C Reactive Protein Test) <span>+</span></a>

					<a class="tags" href="#">Anti Mullerian hormone AMH Test <span>+</span></a>

					<a class="tags" href="#">Prolactin Test <span>+</span></a>

					<a class="tags" href="#">Anti Mullerian hormone AMH Test <span>+</span></a>

					<a class="tags" href="#">Prolactin Test <span>+</span></a>

					<a class="tags" href="#">Hemoglobin Variant Analysis Test <span>+</span></a>

					<a class="tags" href="#">Healthy Heart Package <span>+</span></a>

					<a class="tags" href="#">Fatigue Syndrome Test <span>+</span></a>

					<a class="tags" href="#">Thyroid Profile Total <span>+</span></a>

					<a class="tags" href="#">Follicle Stimulating Hormone FSH Test <span>+</span></a>

					<a class="tags" href="#">Fitness Check Package <span>+</span></a>
	...
	<div class="footer-brands">
		...
		<div class="container">
			...
			<div class="row align-items-center">
				...
				<div class="col-lg-6 col-md-6 payment text-center text-lg-end text-md-end">
				...
				<div class="row">
					...
					<div class="col-lg-12">
						...
						<div class="footer-">
							...
							<p>©2021 All right reserved. Modern Diagnostic & Research Centre Pvt. Ltd.</p>
          ...
          <div class="container">
            ...
            <div class="row justify-content-center">
              ...
              <div class="col-md-8 text-center">
                ...
                <h3 class="mb10">Home Sample Collection Appointment</h3>
                ...
                <div class="form-block fdgn2 mt10 mb10">
                  ...
                  <form action="#" method="post" name="feedback-form">
                    ...
                    <div class="fieldsets row">
                      ...
                      <div class="col-md-6"><input type="phone" placeholder="Phone*" name="phone"></div>

                      <div class="col-md-6"><input type="text" placeholder="Age" name="age"></div>

                    </div>

                    <div class="fieldsets row">

                      <div class="col-md-6"><input type="text" placeholder="City*" name="city"></div>
                      ...
                      <div class="col-md-6 form-group">
                        ...
                        <div class="row align-items-center no-gutters">
                          ...
                          <div class="col-md-6 mt-2 mt-lg-0 mt-md-0 mb-2 mb-lg-0 mb-md-0">

                      		<label class="text-dark ms-1 me-4"><input type="radio" name="gender"/> Male</label>

                      		<label class="text-dark"><input type="radio" name="gender"/> Female</label>
                    ...
                    <div class="fieldsets row">
                      ...
                      <div class="col-md-6"><textarea placeholder="Address" name="message"></textarea></div>

                      <div class="col-md-6"><textarea placeholder="Brief details of your illness" name="message"></textarea></div>
