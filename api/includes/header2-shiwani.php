				...
				<div class="menu-header menu-header2">
					...
					<div class="custom-nav" role="navigation">
						<div class="head-certificates">
							<img src="images/header/certificate.png" alt="Certificates">
						</div>
						<ul class="nav-list onepge">
							...
							<li class="hidemobile"><a href="tel:<?php echo !empty($_SESSION['cityPhone']) ? $_SESSION['cityPhone'] : '+91-124-6712000'; ?>"><img src="images/call-mobile-header.png" alt="Call" style="width:33px" /></a></li>
										...
										<div class="dropdown prof-drop">
											...
											<ul class="dropdown-menu">
												...
												<li style="display:none"><a class="dropdown-item" href="my-addresses">My
														Addresses <i class="fas fa-chevron-right"></i></a></li>
						...
						<button class="searSubmit" type="submit"><img src="images/icon-red-search.png" alt="" /></button>
							...
							<div class="collapse navbar-collapse" id="mynavbar">
								<ul class="navbar-nav ml-auto">
									<li class="nav-item"><a href="about-us" class="nav-link">About Us111</a></li>
										...
										<?php if (count($this->rs_for_doctors) > 0) { ?>
											<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
												<?php for ($i = 0; $i < count($this->rs_for_doctors); $i++) { ?>
													<li><a class="dropdown-item" href="<?= $this->rs_for_doctors[$i]['slug'] ?>">
															<?= $this->rs_for_doctors[$i]['title'] ?>
														</a></li>
												<?php } ?>
											</ul>
										<?php } ?>
									...
									<li class="nav-item dropdown">
										...
										<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
											...
											<li><a class="dropdown-item" href="imaging-test-information"> Imaging Test
													Information </a>
											</li>
											<li><a class="dropdown-item" href="pathology-lab-information"> Pathology Lab
									...
									<li class="nav-item dropdown mob-viewmega">
										...
										<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
											<li><a class="dropdown-item" href="our-doctors"> Test 1 </a> </li>
											<!-- li><a class="dropdown-item"  href="covid-19"> Covid-19 </a> </li> -->
											<!-- <li><a class="dropdown-item"  href="health-packages.html"> Modern Health Packages</a> </li> -->
											<li><a class="dropdown-item" href="imaging-test-information"> Test 2 </a>
											</li>
											<li><a class="dropdown-item" href="imaging-test-information"> Test 3 </a>
											</li>
											<li><a class="dropdown-item" href="imaging-test-information"> Test 4 </a>
											</li>
										...
										<div class="dropdown-menu w-100 mt-0 p-0" aria-labelledby="navbarDropdown">
											...
											<div class="row ">
												<div class="col-md-12 col-lg-12">
													<div style="height:220px;" class="">
														<div class="row megamenu-h">
															<div class="col-md-3 col-lg-3 main-megadrop">
																<ul class="menu " aria-labelledby="navbarDropdownMenuLink">
																	<li>
																		<a class="dropdown-itemnew " href="javascript:void(0)">SGOT (Serum
																			Glutamic Oxaloacetic Transaminase) &raquo;</a>

																		<div class="megadrop">
																			<div class="main-mega-menu">
																				<ul>
																					<li class="ht-inner-sub">
																						<a href="#">AbdomAbdominal X-ray
																							inal X-Abdominal X-ray X-ray
																						</a>
																					</li>
																					<li class="ht-inner-sub">
																						<a href="#">Cervical X-ray </a>
																					</li>
																					<li class="ht-inner-sub">
																	...
																	<li>
																		<a class="dropdown-itemnew" href="javascript:void(0)">Another action
																			&raquo;</a>
																		<div class="megadrop">
																			<div class="main-mega-menu">
									...
									<li class="nav-item dropdown  position-static des-viewmega">
										<a class="nav-link dropdown-toggle" href="for-bloodscan" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
											Book Your Scan
										</a>
										<div class="dropdown-menu w-100 mt-0 p-0" aria-labelledby="navbarDropdown">
											<div class="row ">
													...
													<div style="height:220px;" class="">
														<div class="row megamenu-h">
															<div class="col-md-3 col-lg-3 main-megadrop">
																<ul class="menu " aria-labelledby="navbarDropdownMenuLink">
																	<li>
																		<a class="dropdown-itemnew " href="#">SGOT (Serum
																			Glutamic Oxaloacetic Transaminase) &raquo;</a>
																	...
																	<li>
																		<a class="dropdown-itemnew" href="#">Another action
																			&raquo;</a>
																		<div class="megadrop">
																			<div class="main-mega-menu">
									...
									<li class="nav-item dropdown">
										...
										<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
											<li><a class="dropdown-item" href="radiology/imaging-lab-tests-near/<?= $_SESSION['citySlug']; ?>">
													Radiology Imaging</a> </li>
											<li><a class="dropdown-item" href="pathology/lab-blood-test-near/<?= $_SESSION['citySlug']; ?>">
													Pathology Blood Test</a></li>
										</ul>
									</li>
									<!-- <li class="nav-item"><a href="premium-health-checkup/<?= $_SESSION['citySlug']; ?>"
												class="nav-link">Premium HealthCheckup</a></li> -->
									<li class="nav-item dropdown">
