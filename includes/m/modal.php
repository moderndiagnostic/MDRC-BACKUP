...
<!-- otp Modal End -->
<!-- City Modal Start -->
<div class="action action-confirmation offcanvas offcanvas-bottom common-popup" tabindex="-1" id="cityPopup" aria-labelledby="cityPopup">
     <div class="offcanvas-header px-3">
                    <div class="d-flex align-items-center justify-content-between w-100">
                        <h4 class="text-center w-100">Select Your City</h4>
                        <div class="btnclose">
                            <button type="button" class="text-reset location-close-svg" data-bs-dismiss="offcanvas" aria-label="Close">
                            <i data-feather="x-circle" class="location-close-icon"></i>
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white">
                ...
                <div class="bg-white">
                    ...
                    <section class="location-city-section">
                        <div class="row g-0">
                            ...
                            <div class="col-sm-3 col-4 sCity">
                                <a href="javascript:void(0)" class="<?=$activeClass?>" onclick="changeCity(<?=$cityId?>)">
                                    <div class="city-box">
                                        <figure class="mb-1">
                                            <img src="<?=$cityimage?>" alt="<?=$cityName?>" class="img-fluid city-box-img">
                                        </figure>
                                        <p><?=$cityName?></p>
                                    </div>
                                </a>
                        ...
                        <!-- Serach Name -->
                        <div class="mt-3 sCity d-flex flex-wrap mt-3">
                            <h4 class="text-center w-100 py-2">Other Cities</h4>
