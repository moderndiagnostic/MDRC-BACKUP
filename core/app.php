<?php
	...
	class app extends Singleton{
		...
		public function getPageHeadBody(){
			return $this->pageHeadBody;
		}
		...
		private function getHTMLHeader(){
			...
			if(VIR_DIR == 'admin/' )
			{
				...
				$tmpStr.="<link rel='shortcut icon' type='image/x-icon' href='assets/img/favicon.png'>\n";
			...
			else 
			{
				...
				$tmpStr.="<link rel=\"shortcut icon\" href=\"assets/image/favicon.png\" type=\"image/png\">\n";

				$tmpStr.="<title>".$this->getPageTitle()."</title>\n";
				$tmpStr.="<meta name=\"author\" content=\"".$this->getPageTitle()."\"  />\n";
				$tmpStr.="<meta name=\"keywords\" content=\"".$this->getMetaKeywords()."\"  />\n";
				$tmpStr.="<meta name=\"description\" content=\"".$this->getMetaDescription()."\"/>\n";
				$tmpStr.=$this->getPageHeadBody();

				$tmpStr.='<link rel="stylesheet" href="assets/css/default.css">
...
<link rel="stylesheet" href="assets/css/responsive.css">';
				...
				{					
					$tmpStr.="<body class=\"dark-version\">";
				}
		...
		public function setHeadBody($headBody){
			$this->pageHeadBody = $headBody;
		}
		/************************************************/
		/************************************************/
